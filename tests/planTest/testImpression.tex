...
\begin{itemize}
	...
	\item Après impression, un message \kw{EVT_BOX_PRINTED} est deposé dans la boîte aux lettres \kw{EventsQueue}
\end{itemize}
}
...
\begin{itemize}
	...
	\item Un message \kw{EVT_ANOMALY_PRINTER1} est deposé dans la boîte aux lettres \kw{EventsQueue}.
	\item Le carton est delegué à l'imprimante \kw{Printer2}.
	\item Après impression avec \kw{Printer2}, un message \kw{EVT_BOX_PRINTED} est deposé dans la boîte aux lettres \kw{EventsQueue}
\end{itemize}
}
...
\begin{itemize}
	...
	\item Un message \kw{EVT_ANOMALY_PRINTER2} est deposé dans la boîte aux lettres \kw{EventsQueue}.
...
\begin{itemize}
	...
	\item Un message \kw{EVT_APPLICATION_STOP} est deposé dans la boîte aux lettres \kw{EventsQueue}. 
